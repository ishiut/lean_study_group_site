...
We are an informal learning community exploring [Lean](https://lean-lang.org/) together. 
Participants of all experience levels from complete beginners to advanced users are welcome. 
...
No prior experience with proof assistants or formal logic is required. 
At the first meeting, we will cover how to get started, including

* Interactive, browser-based learning tools 
* Setting up remote coding environments
* Local installation guides for personal devices

## Lean on university-owned computers

The IT Department has approved Lean for installation on university-owned computers. 
I manage software support for this group, so please feel free to reach out if you encounter installation issues, accessibility accommodations, and so on. 